                    ...
                    @if(!is_null($question->answers))
                        @foreach($question->answers as $answer)
                            <li class="vote-item">
                                ...
                                <input type="checkbox" name="answer[]" value="{{ "{$question->id}-{$answer->id}" }}" /><span>{{ $answer->title }}</span>
                                @else
                                <input type="radio" name="answer[]" value="{{ "{$question->id}-{$answer->id}" }}" /><span>{{ $answer->title }}</span>
                                @endif
                            </li>
                        @endforeach
                        <li class="vote-item">
