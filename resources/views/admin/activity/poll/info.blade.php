                            ...
                            <div class="medical-list">
                                <div class="medical-div">
                                    <p style="width: 50%; display: inline; margin-right: 10px;">
                                        <span>活动标题:</span>
                                        <input type="text" name="title" value="{{ !empty($record)? $record->title: '' }}" required="required" placeholder="请输入活动标题" style="width: 40%;"/>
                                    </p><br/><br/>
                                    <p style="width: 50%; display: inline; margin-right: 10px;">
                                        <span>活动发起者:</span>
                                        <input type="text" name="author" value="{{ !empty($record)? $record->author: '' }}" required="required" placeholder="请输入活动发起者" style="width: 40%;"/>
                                    </p><br/>
                                    ...
                                    <p style="width: 100%;">
                                        <span style="width: 150px;">活动内容:</span>
                                        <textarea class="analysis" id="content" name="content" required="required" placeholder="请输入活动内容" style="width: 100%; padding: 0 10px;">{{ !empty($record)? $record->content: '' }}</textarea>
                                    </p><br/>
                                </div>
                            </div>
                        </div>
